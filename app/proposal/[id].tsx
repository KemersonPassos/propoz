...
export default function ProposalDetails() {
  ...
  const sendWhatsApp = () => {
    ...
    message += `🔗 Veja o detalhamento completo aqui: https://propoz.pages.dev/view/${proposal.share_id || proposal.id}\n\n`;
  ...
  const copyLink = () => {
    const url = `https://propoz.pages.dev/view/${proposal?.share_id || id}`;
